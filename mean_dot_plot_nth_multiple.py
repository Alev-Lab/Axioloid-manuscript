...
def do_plot(files):
    ...
    df.insert(4,'Period',df['value']*60)
    ...
    sns.stripplot(data=df,x='#th_seg',y='Period',dodge=True,hue=hue, order=None, hue_order=None,
                 #palette = colorlist1,alpha=0.75, edgecolor='black', linewidth=1)
                 alpha=0.75,  linewidth=1,edgecolor=None)
